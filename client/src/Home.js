              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="card border-0 mb-3">
                    <img src={petBoardingImage} className="card-img-top" alt="Service 1" />
                ...
                <div className="col-md-4">
                  <div className="card border-0 mb-3">
                    <img src={petSittingImage} className="card-img-top" alt="Service 2" />
                    <div className="card-body text-center">
                ...
                <div className="col-md-4">
                  <div className="card border-0 mb-3">
                    <img src={petWalkingImage} className="card-img-top" alt="Service 3" />
                    <div className="card-body text-center">
                      <h5 className="card-title mb-2">Dog Walking</h5>
